...
public class StringKit {
	...
	public static String convert(String source, String srcCharset, String newCharset) {
		if(StringKit.isBlank(srcCharset)) {
			srcCharset = ISO_8859_1;
		}

		if(StringKit.isBlank(newCharset)) {
			srcCharset = UTF_8;
		}

		if (StringKit.isBlank(source) || srcCharset.equals(newCharset)) {
			return source;
		}
		try {
	...
	public static ByteBuffer toByteBuffer(String str, @Nullable String charset) {
		return ByteBuffer.wrap(StringKit.encode(str, charset));
	}
