...
public class JwtUtil {
    ...
    public static String verifySignature(String token, String secret)
            throws JOSEException, JwtSignatureVerifyException, ParseException {
    ...
    public static class JwtSignatureVerifyException extends Exception {
        public JwtSignatureVerifyException(String msg) {
            super(msg);
        }
    }
}
